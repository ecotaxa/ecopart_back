import { InstrumentModelRequestCreationtModel, InstrumentModelRequestModel, InstrumentModelUpdateModel, InstrumentModelResponseModel } from "../../../domain/entities/instrument_model";
import { PreparedSearchOptions, SearchResult } from "../../../domain/entities/search";

export interface InstrumentModelDataSource {
    create(instrument: InstrumentModelRequestCreationtModel): Promise<number>;
